...
using SimpleCarManagment.Authentication;
using Radzen;
namespace SimpleCarManagment
{
    public partial class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration.GetConnectionString("SimpleCarManagmentDBConnection"));
            ...
            services.AddScoped<SimpleCarManagmentDbService>();

            services.AddDbContext<SimpleCarManagment.Data.SimpleCarManagmentDbContext>(options =>
            {
              options.UseSqlServer(Configuration.GetConnectionString("SimpleCarManagmentDBConnection"));
            });
